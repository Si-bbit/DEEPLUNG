...
# 示例：加载模型
model_path1 = get_resource_path("modelpth/UBUNep500-loss0.310-val_loss0.414.pth")
...
class DeeplabV3(object):
    _defaults = {
        ...
        # "model_path"        :"D:/desktop/deeplab/ep450-loss0.292-val_loss0.403.pth",
    ...
    def __init__(self, **kwargs):
        ...
        if self.num_classes <= 21:
            self.colors = [ (0, 0, 0), (128, 0, 0), (0, 128, 0), (0, 0, 128), (128, 128, 0), (0, 0, 128), (128, 0, 128), (0, 128, 128), 
